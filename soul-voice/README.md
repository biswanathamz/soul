...
Local neural TTS microservice for SOUL — gives the Manager a natural, polite voice.
FastAPI + [Piper](https://github.com/rhasspy/piper), port **7789**, CPU-only (never
competes with Ollama for the GPU). Design: `docs/voice-and-face.md` §4.1.
